...
export const ghostRunConfig = {
  ...
  sprintShoulderForwardAmp: 0.62,
  sprintShoulderBackwardAmp: 0.05,
  sprintShoulderLeadForwardAmp: 0.42,
  sprintShoulderLeadGatherAmp: 0.16,
  sprintShoulderReachForward: 0.06,
  sprintShoulderReachBackward: 0.018,
  sprintShoulderReachLift: 0.016,
  sprintShoulderRollForwardAmp: 0.18,
  sprintShoulderUpperArmFollow: 0.7,
