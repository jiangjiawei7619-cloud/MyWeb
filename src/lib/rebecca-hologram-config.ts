...
/** Rebecca 湿地面倒影 — 与本体同链路，略暗一点 */
export const REBECCA_REFLECT = {
  /** 相对本体亮度（<1 略暗） */
  reflectDimmer: 0.84,
  reflectAlphaFloor: 0.92,
  reflectBlurScale: 0.22,
  /** 倒影平面朝外偏移（米），避免与建筑镜像暗面重叠 */
  reflectForwardOffset: 0.32,
} as const;
